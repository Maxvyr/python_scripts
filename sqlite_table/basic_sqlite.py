...
cursor.execute('CREATE TABLE album (album_id INTEGER NOT NULL PRIMARY KEY, artist_id INTEGER REFERENCES artiste, title VARCHAR, year INTEGER);')
...
cursor.execute('INSERT INTO album (artist_id, title,year) VALUES (' + str(vexento_id) + ', "Never Letting Go", "2017");')
